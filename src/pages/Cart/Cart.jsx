  ...
  return <>
     {cartInfo === null ? <Loading/> : <section>
        ...
        <i className="fa-brands fa-opencart text-3xl"></i>
            <h2 className="text-xl text-slate-600 font-semibold relative before:absolute before:w-0.5 before:h-3/4 before:bg-slate-600 before:-left-3 before:top-1/2 before:-translate-y-1/2  ">Your Shopping Cart</h2>
        </div>
          ...
          ? <div className="mt-6 bg-gray-100 rounded-md p-5 shadow-md border border-gray-300 flex flex-col items-center justify-center gap-3">
                ...
                <Link to= "/" className="btn bg-primary-600 hover:bg-primary-700 transition-colors duration-300 text-white" >
                    Back to Home
                </Link> 
          </div>
          ...
          <div className="space-y-3 mb-4">
            ...
            <div className="border-t border-gray-300 pt-3 flex justify-between">
              ...
              <span className="text-green-600 font-bold text-lg"> {cartInfo.data.totalCartPrice} L.E</span>
            </div>
          </div>
  
          <div className="space-y-3">
          <button className="w-full btn bg-primary-700 hover:bg-primary-800  text-white py-3 rounded-lg font-semibold transition-colors duration-300">
