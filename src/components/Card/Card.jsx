...
export default function Card({productInfo}) {
     ...
     const { imageCover, title, price, category, description , ratingsAverage} = productInfo
...
<div className="p-5 space-y-3">
  <header className="space-y-1">
    ...
    <span className="text-xs font-semibold uppercase tracking-wide bg-primary-50 text-primary-600 px-2 py-1 rounded-full inline-block">{category.name}</span>
  </header>
  ...
  <div className="flex justify-between items-center pt-2">
    <span className="text-base font-semibold text-green-600">{price}L.E</span>
